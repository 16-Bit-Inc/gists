...
dicom_2_tiff = Dicom2Tiff(
    dicom_path="report.dcm",
    tiff_path="report.tiff",
)

dicom_2_tiff.convert()
dicom_2_tiff.get_metadata()


os.mkdir(r"C:\Program Files (x86)\Lunar\DICOM\Reports\TIFF")
shutil.copy2("report.tiff", r"C:\Program Files (x86)\Lunar\DICOM\Reports\TIFF")
