    ...
    try:
        ...
        for dicom_filename in os.listdir(RHO_REPORTS_DIR):
            ...
            try:
                ...
                tiff_dir_path = os.path.join(TIFF_REPORTS_DIR, dicom_filename.split(".")[0])
                ...
                print(f"Exception while processing dicom: {e} | Moving the dicom file: {dicom_filename} to {FAILED_RHO_REPORTS_DIR}.")
                shutil.move(dicom_path, os.path.join(FAILED_RHO_REPORTS_DIR, dicom_filename))
